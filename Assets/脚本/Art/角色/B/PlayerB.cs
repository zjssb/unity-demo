...
public class PlayerB : Player
{
    ...
    private void Start()
    {
        ...
        普通攻击 = transform.Find("Ex").GetComponent<普通攻击_B>();
        战技 = transform.Find("Ex").GetComponent<战技_B>();
        大招 = transform.Find("Ex").GetComponent<大招_B>();
    }
